...
const NotFoundPage = () => {
  const [mov, setMov] =useState("sm32979272");
        ...
        {<p>
          <div style={{width: `100%`}}>
            <div class="wrapper" style={{paddingBottom: `56.25%`}}>
              <iframe title={mov} allowfullscreen="allowfullscreen" allow="autoplay" src={`https://embed.nicovideo.jp/watch/${mov}?oldScript=1&referer=&from=0&allowProgrammaticFullScreen=1`} style={{position: `absolute`, width: `100%`, height: `100%`, border: `none`,}}></iframe>
            </div>
          </div>
        </p>}
    </Layout>
