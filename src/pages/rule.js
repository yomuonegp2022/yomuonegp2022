...
const Rule = () => (
  <Layout title="大会ルール">
    ...
    <p>
      <table border="2" bordercolor="#444444" style={{whiteSpace: `nowrap`, maxWidth: `500px`}}>
        <tbody>
          ...
          <tr>
            <th>投票期間</th>
            <th>4月2日～4月<span style={{ color: `#ff0000` }}>15</span>日</th>
          </tr>
          <tr>
            <th>結果発表<sup>※</sup></th>
            <th>4月<span style={{ color: `#ff0000` }}>22</span>日</th>
          </tr>
        </tbody>
      </table>
    </p>
    ...
    <p>
      ...
      他の音声についても、個別にご相談いただいて問題ないと認められれば許可する場合がございます。他に許可した音声については<StLink to="#supplement">補足</StLink>をご覧ください。
    </p>
    ...
    <p>
      ...
      この場合投稿日時の表記は非公開投稿時点のものとなりますので、運営側でも確認しますが、ニコレポの動画投稿通知を設定しておく等していただけますとありがたいです。
    </p>
    ...
    <p>
      <ul>
        <li>
          投票期間内（4月2日00:00～4月<span style={{ color: `#ff0000` }}>15</span>日23:59）に投票してください。
        </li>
        <li>
          各参加者には<span style={{ color: `#ff0000` }}>5</span>票ずつ持ち票が与えられますので、その<span style={{ color: `#ff0000` }}>5</span>票を自分の作品以外の作品に投票してください。<br />
          一つの作品に複数票投じることも可能ですが、<span style={{ color: `#ff0000` }}>重複は3票まで</span>とします。
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <ul>
            ...
            <li>
              応募作品数に関係なく持ち票は<span style={{ color: `#ff0000` }}>5</span>票となります。<br />
        ...
        <li>
          ...
          <ul>
            <li>
              M-1グランプリの出囃子（Fatboy Slim - Because We Can）
            </li>
          </ul>
        </li>
      </ul>
